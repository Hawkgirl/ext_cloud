...
class AzureComputecls(AzureBaseCloudcls, BaseComputecls):
	...
	def create_instance(self, image_id=None, key_name=None, security_groups=None, instancetype_id = "ExtraSmall", name = None, zone=None, subnet_id=None, private_ips=None, user_data=None, storage_name=None, username=None, password=None):
		...
		if storage_name is None:
			#storage name not provided,pick any storage account as stroage account is an expensive operation
	...
	def create_instances(self, count=1,image_id=None, key_name=None, security_groups=None, instancetype_id = 'Small', name = None, zone=None, subnet_id=None, private_ips=None,user_data=None):  pass
