...
class AzureComputecls(AzureBaseCloudcls, BaseComputecls):
    ...
    def list_instances(self):
        ...
        for azure_instance in azure_instances:
            instance = AzureInstancecls(azure_instance,
    ...
    def create_instance(self,
        ...
        if image.os == 'Linux':
            os_config = LinuxConfigurationSet(
                host_name=name,
                user_name=username,
        ...
        os_hd = OSVirtualHardDisk(image_id,
                                  os_image_url,
                                  disk_label=target_blob_name)

        self.__SMS.create_hosted_service(
            service_name,
            service_name,
            location=self._credentials['region_name'])
    ...
    def list_instancetypes(self):
        ...
        for azure_instancetype in azure_instancetypes_dict:
            instancetype = AzureInstanceTypecls(
                azure_instancetypes_dict[azure_instancetype],
                credentials=self._credentials)
