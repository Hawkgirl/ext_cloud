...
class OpenStackInstanceTypecls(OpenStackBaseCloudcls, BaseInstanceTypecls):
	...
	def __init__(self, *arg, **kwargs):
		...
		super(OpenStackInstanceTypecls, self).__init__(id=self.__openstack_instancetype.id, name=self.__openstack_instancetype.name, credentials=kwargs['credentials'])
