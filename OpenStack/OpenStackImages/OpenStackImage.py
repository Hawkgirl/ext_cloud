...
class OpenStackImagecls(OpenStackBaseCloudcls, BaseImagecls):
	...
	@property
	def arch(self): return self.__openstack_image['architecture'] if hasattr(self.__openstack_image, 'architecture') else None


	@property
	def os_type(self): return self.__openstack_image['os_type'] if hasattr(self.__openstack_image, 'os_type') else None
