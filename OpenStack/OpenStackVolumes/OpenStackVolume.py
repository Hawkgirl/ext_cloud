...
class OpenStackVolumecls(OpenStackBaseCloudcls, BaseVolumecls):
    ...
    def __init__(self, *arg, **kwargs):
        ...
        super(OpenStackVolumecls, self).__init__(
            id=self.__openstack_volume.id,
            name=self.__openstack_volume.name,
    ...
    def attached_to(self):
        return None if len(
            self.__openstack_volume.
            attachments) == 0 else self.__openstack_volume.attachments[0][
                'server_id']
