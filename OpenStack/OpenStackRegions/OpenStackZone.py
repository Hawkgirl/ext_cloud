...
class OpenStackZonecls(OpenStackBaseCloudcls, BaseZonecls):
	...
	def __init__(self, *args, **kwargs):
		...
		super(OpenStackZonecls, self).__init__(id=self.__openstack_zone.zoneName, name=self.__openstack_zone.zoneName, credentials=kwargs['credentials'])

	@property
	def hosts_count(self):
		 if self.__openstack_zone.hosts is None: return 0
